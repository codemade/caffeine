...
var VariationCategory = (function (_React$Component) {
  function VariationCategory() {
    _classCallCheck(this, VariationCategory);

    _get(Object.getPrototypeOf(VariationCategory.prototype), 'constructor', this).apply(this, arguments);
  }

  _inherits(VariationCategory, _React$Component);

  _createClass(VariationCategory, [{
    key: 'render',
    value: function render() {
      var variations = this.props.variations.map(function (variation) {
        return React.createElement(Variation, { variation: variation });
      });
...
},{"../../app/components/variation.react.js":3,"react":159}],2:[function(require,module,exports){
'use strict';
...
var VariationList = (function (_React$Component) {
  function VariationList() {
    _classCallCheck(this, VariationList);

    _get(Object.getPrototypeOf(VariationList.prototype), 'constructor', this).apply(this, arguments);
  }

  _inherits(VariationList, _React$Component);

  _createClass(VariationList, [{
    key: 'render',
    value: function render() {
      var _this = this;

      var categories = this.props.categories.map(function (category) {
        var variations = _this.props.variations.filter(function (variation) {
          return variation.category === category.id;
        });
        return React.createElement(VariationCategory, { category: category, variations: variations });
      });
      ...
      return React.createElement(
        ...
        React.createElement(
          'h2',
          null,
          'Diese Variationen sind verfügbar:'
        ),
        categories
      );
    }
...
},{"../../app/components/variation-category.react.js":1,"react":159}],3:[function(require,module,exports){
'use strict';
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(VariationList, { categories: DataSource.categories,
...
},{"../app/components/variation-list.react.js":2,"../variations-data.js":161,"react":159}],5:[function(require,module,exports){
/**
...
var variations = [
// Intenso
{ id: 1, intensity: 12, category: 1, price: 0.39, name: 'Kazaar' }, { id: 2, intensity: 10, category: 1, price: 0.35, name: 'Ristretto' }, { id: 3, intensity: 11, category: 1, price: 0.39, name: 'Dharkan' }, { id: 4, intensity: 8, category: 1, price: 0.35, name: 'Roma' }, { id: 5, intensity: 9, category: 1, price: 0.35, name: 'Arpeggio' },
// Espresso
{ id: 6, intensity: 3, category: 2, price: 0.35, name: 'Cosi' }, { id: 7, intensity: 5, category: 2, price: 0.35, name: 'Capriccio' }, { id: 8, intensity: 4, category: 2, price: 0.35, name: 'Volluto' }, { id: 9, intensity: 6, category: 2, price: 0.35, name: 'Livanto' },
// Pure Origin
{ id: 10, intensity: 10, category: 3, price: 0.39, name: 'Indriya from India' }, { id: 11, intensity: 3, category: 3, price: 0.39, name: 'Bukeela ka Ethiopia' }, { id: 12, intensity: 4, category: 3, price: 0.39, name: 'Dulsão do Brasil' }, { id: 13, intensity: 6, category: 3, price: 0.39, name: 'Rosabaya de Colombia' },
// Lungo
{ id: 14, intensity: 4, category: 4, price: 0.37, name: 'Vivalto Lungo' }, { id: 15, intensity: 4, category: 4, price: 0.37, name: 'Linizio Lungo' }, { id: 16, intensity: 8, category: 4, price: 0.37, name: 'Fortissio Lungo' },
// Decaffeinato
{ id: 17, intensity: 4, category: 5, price: 0.37, name: 'Volluto Decaffeinato' }, { id: 18, intensity: 7, category: 5, price: 0.37, name: 'Decaffeinato Intenso' }, { id: 19, intensity: 4, category: 5, price: 0.39, name: 'Vivalto Lungo Decaffeinato' }, { id: 20, intensity: 9, category: 5, price: 0.37, name: 'Arpeggio Decaffeinato' },
// Variations
{ id: 21, intensity: 6, category: 6, price: 0.42, name: 'Caramelito' }, { id: 22, intensity: 6, category: 6, price: 0.42, name: 'Vanilio' }, { id: 23, intensity: 6, category: 6, price: 0.42, name: 'Ciocattino' }];
