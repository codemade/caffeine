...
/***/ function(module, exports) {
	...
	var Store = (function () {
	  ...
	  _createClass(Store, [{
	    ...
	    value: function addChangeListener(eventIdentifier, listener) {
	      var _this = this;
	      ...
	      return function () {
	        removeChangeListenerWithId(listenerWithId.id, eventIdentifier, _this);
	      };
	    }
	  }, {
	    key: "emitChange",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ShoppingCartBadge = __webpack_require__(20);
